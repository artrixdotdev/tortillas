...
/// the broadcast channel instead of an mpsc or oneshot channel.
///
/// (This may shoot us in the foot later -- or more aptly, blow our entire leg
/// off. But it shouldn't.)
#[derive(Debug, Clone)]
pub enum PeerResponse {
   ...
   /// A generic receive message with a slot for a PeerMessage. This does force
   /// the engine to handle and manage exactly what PeerMessage variant we're
   /// receiving, but IMO, this is a better way of handling messages.
   Receive {
