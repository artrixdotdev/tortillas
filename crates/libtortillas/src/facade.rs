...
pub use crate::{
   ...
   frontend::{
      CoreEvent, CoreEventKind, EngineView, EventStreamError, EventSubscription, FrontendHealth,
      FrontendHealthLevel, PeerView, TorrentProgress, TorrentTransfer, TorrentView, TrackerView,
   },
